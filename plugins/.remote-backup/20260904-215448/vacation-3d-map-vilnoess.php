...
add_filter('vacation3d_maps', function ($maps) {
    $maps['vilnoess'] = array(
        ...
        'config'   => array(
            ...
            // Erkannte Pausen (Tag + Dauer in Minuten, siehe clean_gpx.py-Ausgabe) mit Namen versehen.
            'breaks'         => array(
                array('day' => 2, 'minutes' => 54, 'label' => 'Geisleralm'),
                array('day' => 3, 'minutes' => 28, 'label' => 'Waldschenke'),
            ),
        ),
    );
    return $maps;
